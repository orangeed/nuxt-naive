  ...
  <div id="Read" class="content">
    ...
    <div class="content-search">
      <el-form :inline="true" :model="readForm">
        <el-form-item label="标题">
          <el-input v-model="readForm.title" placeholder="请输入文章标题"></el-input>
        </el-form-item>
        <el-form-item>
    ...
    <div class="content-table">
      <el-table :data="tableData" stripe :max-height="fullScreen.fullHeight.value - 300">
        ...
        <el-table-column prop="updateTime" label="时间" width="300" />
    ...
    <el-drawer v-model="showDrawer" :title="drawerTitle">
      <el-form :model="createForm" label-width="90px">
        <el-form-item label="书籍名称：">
          <el-input v-model="createForm.title" placeholder="请输入书籍名称" />
        </el-form-item>
        <el-form-item label="作者：" class="mt-4">
          <el-input v-model="createForm.author" placeholder="请输入书籍作者" />
        </el-form-item>
        ...
        <el-form-item label="封面：" class="mt-4">
          <el-upload action="" :auto-upload="false" :limit="1" list-type="picture-card" :on-preview="handlePictureCardPreview">
