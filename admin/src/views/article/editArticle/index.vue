    ...
    <div class="content-search shadow-xl">
      ...
      <el-form :inline="true" :model="markDownInfo">
        <el-form-item label="文章名称">
          <el-input v-model="markDownInfo.title" placeholder="请输入文章名称"></el-input>
        </el-form-item>
        <el-form-item label="封面地址">
          <el-input v-model="markDownInfo.img" placeholder="请输入封面地址"></el-input>
        </el-form-item>
        <el-form-item label="作者名称">
          <el-input v-model="markDownInfo.author" placeholder="请输入作者名称"></el-input>
        </el-form-item>
        <el-form-item label="分类">
          <!-- <el-date-picker
            v-model="markDownInfo.time"
            type="date"
